...
public class Domicilio implements Serializable{
	...
	@OneToOne(mappedBy = "dom") //nombre del atributo que esta en la case contacto que esta en la relacion osea donde esta el join que es el que referencia a este 
